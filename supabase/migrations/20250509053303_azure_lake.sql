/*
  ...
  1. Changes
    - Add email_confirmed_at check to RLS policies
    - Update existing policies to require email verification
  
  2. Security
    - Users must verify email before accessing protected resources
    - Maintains existing RLS policies with additional verification check
*/
